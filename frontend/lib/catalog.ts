...
export type Product={id:string;product_type_id:string;brand_id?:string;code?:string;status:string;version:number;name?:string;default_sku?:string;category?:string|null;stock?:number|null};
