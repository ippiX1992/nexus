...
export type Transfer={id:string;from_location_id:string;to_location_id:string;variant_id:string;quantity:number;reason?:string|null;status:string;version:number};
