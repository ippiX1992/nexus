...
Nexus es una plataforma SaaS API-first. Sobre los Módulos 1 y 2 cerrados, la rama `feature/catalog-core` incorpora M3.0 Catalog Foundation: Products/Variants, clasificación, localización básica y asignación multi-Store con los servicios transversales del Platform Kernel.
